  ...
  container.on(
    {
      render: function (args) {
        ...
        //we are just going to hide the OOB "site" field.
        // Hide the OOB Site Column.  Added UConn Multi-Select Units
        $("div[id$=NamingOpportunityAddForm]").find("[id$=SITEID_container]").hide();
      },
