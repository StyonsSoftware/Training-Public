...
'------------------------------------------------------------------------------
''' <summary>
''' Represents the UI model for the 'ConstituentAddressPicklistSELECTEDADDRESSES' data form
''' </summary>
Partial Public Class [ConstituentAddressPicklistSELECTEDADDRESSESUIModel]
